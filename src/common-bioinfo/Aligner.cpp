...
void Aligner::set_parameters(size_t max_gap/* = 50*/, size_t max_diff/* = 10*/)
{
        ...
        double (*delta)(bool))
{
    ...
    const std::string X = XX->substr(leftmost_pos);
    const std::string& Y = YY->length() > XX->length() - leftmost_pos ? YY->substr(0, XX->length() - leftmost_pos) : *YY;
